...
p<-ggplot(melted_data,aes(x=variable,y=vreorder(EVTYPEl-value),=factor(gender)))+
 variablebar(stat="identity")+
...
```
## Conclusion
Base on analysis between storm event types versus counts of fatalities and injuries, and event types versus damages to properties and corps, we suggest more research efforts should be put on Tornado events.